    ...
    <Form className='loginSignUp'>
      <div>
        ...
        <div>
          ...
          <Field className='inputSignUp' type="text" name="nom" placeholder=' Entrer votre nom'/>
          <ErrorMessage name="nom" component="div" className={touched.nom && errors.nom ? "error" : ""} />
        </div>
        <br/>
        <div>
          <label className='labelSignUp'>Prenom *</label>
          <Field className='inputSignUp' type="text" name="prenom" placeholder=' Entrer votre prenom'/>
        ...
        <div>
          ...
          <Field className='inputSignUp' type="number" name="tel" placeholder=' Entrer votre numero'/>
          <ErrorMessage name="tel" component="div" className={touched.tel && errors.tel ? "error" : ""} />
        </div>
        <br/>
        <div>
        <label className='labelSignUp'> Email * </label>
        <Field className='inputSignUp' type="text" name="email" placeholder='  email' />
      ...
      <div>
        ...
        <Field className='inputSignUp' type="password" name="password"placeholder='  Mot de passe' />
